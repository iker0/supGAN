...
--TODO: feed input to fast RCNN and get 64 output label output_frcn. Pass it to fGx
...
--   print('I am printing a global var:',Global_Var)
   print(IsFace:sum(), ' faces detected out of 64 images')
